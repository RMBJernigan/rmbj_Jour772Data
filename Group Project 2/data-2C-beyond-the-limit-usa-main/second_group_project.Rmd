...
drought_data <- read_csv("data/processed/north_dakota_drought_severity_data - Sheet1.csv")
...
```{r}
year_2020_only <- drought_data_year_filtered %>%
  filter(year == "2020") %>%
  summarise(d0-d4_Avg = mean(D0-D4))
```