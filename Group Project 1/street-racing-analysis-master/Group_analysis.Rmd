...
streetracing <-read_csv("input/street-racing-fatalities.csv")

# Loading in the "fatalities" dataframe provided by the Times.
fatalities <-read_csv("output/fatalities.csv")
...
# Creates a new object called behind_wheel 
 ...
 ## AND THEN rearranges the table's appearance by pivoting wider(increasing the number of columns and decreasing the number of rows)
