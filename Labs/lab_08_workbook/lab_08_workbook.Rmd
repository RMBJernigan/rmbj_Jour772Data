...
#Information is not included or missing. No full numbers at some parts, or others are missing. Also column names are confusing
```
...
opioid_scrape_clean <- opioid_scrape %>%
  clean_names() %>%
  rename(opioid_death_rate = opioid_involved_overdose_deaths_100_000_persons1_2018,
        opioid_prescription_rate = opioid_prescriptions_100_persons2_2018) 
